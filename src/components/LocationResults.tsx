    ...
    <div className="flex">
      <div
        className={classNames(
          "overflow-y-auto sm:overflow-auto sm:border lg:w-1/3",
          {
        ...
        {state.mapLocations && state.mapLocations.length > 0 ? (
          ...
          <AlternativeVerticals
            ...
            customCssClasses={{
              ...
              allCategoriesLink:
                "text-gold cursor-pointer hover:underline focus:underline",
            }}
          />
        )}
      </div>
      <div
        className={classNames("w-full xl:w-3/4", {
